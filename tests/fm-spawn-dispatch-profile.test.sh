...
test_raw_prime_launch_is_rejected_before_endpoint_creation() {
  ...
  ids=(profile-raw-prime-z15b profile-raw-prime-command-z15b profile-raw-prime-command-end-z15b profile-raw-prime-exec-z15b profile-raw-prime-env-z15b profile-raw-prime-env-path-z15b profile-raw-prime-node-z15b profile-raw-prime-node-flag-z15b profile-raw-prime-node-relative-z15b profile-raw-prime-node-variable-z15b profile-raw-prime-env-chdir-node-z15b profile-raw-prime-shell-z15b profile-raw-prime-shell-cluster-z15b profile-raw-prime-shell-option-z15b profile-raw-prime-time-z15b profile-raw-prime-qualified-time-z15b profile-raw-prime-quoted-z15b profile-raw-prime-symlink-z15b profile-raw-prime-alias-z15b profile-raw-prime-nohup-z15b profile-raw-prime-nice-z15b profile-raw-prime-timeout-z15b profile-raw-prime-timeout-end-options-z15b profile-raw-prime-cd-node-z15b profile-raw-prime-path-assignment-z15b profile-raw-prime-semicolon-z15b profile-raw-prime-newline-z15b profile-raw-prime-substitution-z15b profile-raw-prime-quoted-substitution-z15b profile-raw-prime-substitution-quoted-paren-z15b profile-raw-prime-assignment-substitution-z15b profile-raw-prime-backtick-z15b profile-raw-prime-eval-z15b profile-raw-prime-variable-z15b profile-raw-prime-unresolved-variable-z15b profile-raw-prime-process-substitution-z15b profile-raw-prime-output-process-substitution-z15b profile-raw-prime-redir-process-substitution-z15b profile-raw-prime-redir-command-substitution-z15b profile-raw-prime-pwd-space-z15b profile-raw-prime-redir-z15b profile-raw-prime-reserved-z15b profile-raw-prime-launcher-alias-z15b profile-raw-prime-system-launcher-z15b)
...
SH
  ...
  commands=("prime-agent --flag" "command prime-agent --flag" "command -- prime-agent --flag" "exec prime-agent --flag" "env prime-agent --flag" "env PATH=$env_primebin:\$PATH q --flag" "node $prime_package/dist/bundle/cli.js" "node --trace-warnings $prime_package/dist/bundle/cli.js" "node './Linked Prime/dist/bundle/cli.js'" "entry=$prime_package/dist/bundle/cli.js; node \$entry" "env -C $prime_package node dist/bundle/cli.js" "sh -c prime-agent" "bash -lc prime-agent" "bash -o posix -c prime-agent" "time -p prime-agent" "$time_bin -p prime-agent" "'$FAKEBIN_DIR/prime-agent' --flag" "p --flag" "prime-proxy --flag" "nohup prime-agent --flag" "nice -n 10 prime-agent --flag" "timeout 10 prime-agent --flag" "timeout -- 10 prime-agent --flag" "cd $prime_package; node dist/bundle/cli.js" "PATH=$FAKEBIN_DIR:\$PATH p --flag" "claude --flag;prime-agent" $'custom-agent --flag\nprime-agent --flag' 'claude --flag $(prime-agent)' 'echo "$(prime-agent)"' 'echo "$(printf '\'')'\''; prime-agent)"' 'FOO="$(prime-agent)" custom-agent --flag' 'echo `prime-agent`' 'eval prime-agent' 'runner=prime-agent; $runner --flag' '$runner --flag' 'cat <(prime-agent)' 'cat >(prime-agent)' 'cat < <(prime-agent)' 'cat >$(prime-agent)' 'node "$PWD/Linked Prime/dist/bundle/cli.js"' "2>$CASE_DIR/prime.err prime-agent --flag" "if true; then prime-agent; fi" "envx prime-agent --flag" "/usr/bin/arch prime-agent --flag")
