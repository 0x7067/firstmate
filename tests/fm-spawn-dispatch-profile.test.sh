...
SH
  ...
  out=$(
    ...
    HOME="$HOME_DIR" PRIME_API_KEY=ambient-prime OPENAI_API_KEY=ambient-openai \
      ...
      SENTRY_DSN=https://key@example.test/1 CLAUDECODE=1 GROK_AGENT=1 GEMINI_CLI=1 \
