...
prime-agent is likewise crewmate/scout-only because Prime 0.8.0 exposes `agent_end` instead of Pi's primary `agent_settled` boundary; the harness-adapters skill owns the verified lifecycle facts.
